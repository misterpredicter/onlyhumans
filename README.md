...
For a paid end-to-end production example with x402, run `demo-create-task.ts`.
...
- `1%` goes to the founder.

Inside the `90%`, idea contributors choose their own take and workers earn the remainder. The docs page includes pricing bands, callback examples, and full request/response payloads.
